# Star Mark Remover Extension - Walkthrough
...
- **processor.worker.js**: The AI brain.
  ...
  - Performs image preprocessing, star mark detection, and interference.
...
2. "Identifying star mark patterns..." (30%)
...
### C. Manual Masking
- Users can paint over the star mark if the auto-detection misses it.
...
2. **Single**: Drop an image, click "Remove Star Mark".
3. **Batch**: Drop multiple images, click "Process Batch". Wait for all to finish, then download.
4. **Manual**: Drop an image, paint over the star mark, click "Remove Object".
